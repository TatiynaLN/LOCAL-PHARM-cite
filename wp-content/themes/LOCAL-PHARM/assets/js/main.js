...
Object(_modules_mobileMenu__WEBPACK_IMPORTED_MODULE_0__["default"])(); // modal();
// slider();
...
function mobileMenu() {
  if (document.getElementById('menu__button')) {
      ...
      mobileMenuItems.forEach(function (link) {
        link.addEventListener('click', function (e) {
          if (screenWidth > 50) {
            ...
            _mobileMenu.classList.remove('nav-catalog--active'); // body.classList.remove('no-scroll');
    ...
    var _mobileMenu = document.querySelector('.nav-catalog');

    var mobileMenuItems = document.querySelectorAll('.menu-item'); // const htmlElement = document.getElementsByTagName('html')[0];
    ...
    hamburger.addEventListener('click', function () {
      ...
      _mobileMenu.classList.toggle('nav-catalog--active'); // body.classList.toggle('no-scroll');
